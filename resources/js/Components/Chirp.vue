...
<template>
    <div class="p-6 flex space-x-2 min-w-0">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-gray-600 -scale-x-100 flex-shrink-0 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <div class="flex-1 min-w-0">
            ...
            <p v-else class="mt-4 text-lg text-gray-900 break-words overflow-hidden">{{ chirp.message }}</p>
        </div>
    </div>
</template>
